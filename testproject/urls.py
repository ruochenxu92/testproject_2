...
urlpatterns = patterns('',
    ...
    url(r'^CourseUpdate/(?P<pk>[\w-]+)$', views.CourseUpdate.as_view()),
    url(r'^ArticleUpdate/(?P<pk>[\w-]+)$', views.ArticleUpdate.as_view()),
    ...
    url(r'^renewcourses/$', 'task.views.Renew'),
    ...
    url(r'^Login/message/$', 'task.views.SendMessage'),
    ...
    url(r'^courses/$', 'task.views.Courses'),
